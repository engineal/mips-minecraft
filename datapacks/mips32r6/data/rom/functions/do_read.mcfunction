...
execute if score rom_level logging matches 1.. run tellraw @p [{"text":"ROM["},{"score":{"name":"device_address","objective":"rom"}},{"text":"] -> "},{"score":{"name":"value","objective":"mips32r6_mem"}}]
