...
execute if score handled mips32r6_mem matches 1 if score mem_level logging matches 1.. run tellraw @p [{"text":"VADDR["},{"score":{"name":"address","objective":"mips32r6_mem"}},{"text":"]->"},{"score":{"name":"value","objective":"mips32r6_mem"}}]
execute if score handled mips32r6_mem matches 1 if score mem_level logging matches 2.. run tellraw @p [{"text":"PADDR["},{"score":{"name":"physical_address","objective":"mips32r6_mem"}},{"text":"]->"},{"score":{"name":"value","objective":"mips32r6_mem"}}]
