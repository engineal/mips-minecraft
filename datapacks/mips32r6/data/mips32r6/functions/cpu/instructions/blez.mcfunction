...
execute if score cpu_level logging matches 1.. run tellraw @p [{"text":"blez "},{"score":{"name":"rs","objective":"mips32r6_cpu"}},{"text":", "},{"score":{"name":"immediate","objective":"mips32r6_cpu"}}]
...
execute if score value mips32r6_gpr matches ..0 run scoreboard players operation pc mips32r6_cpu += tmp_val mips32r6_cpu
