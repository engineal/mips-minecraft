...
execute if score cpu_level logging matches 1.. run tellraw @p [{"text":"xori "},{"score":{"name":"rt","objective":"mips32r6_cpu"}},{"text":", "},{"score":{"name":"rs","objective":"mips32r6_cpu"}},{"text":", "},{"score":{"name":"unsigned_immediate","objective":"mips32r6_cpu"}}]
