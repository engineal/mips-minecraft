...
#
execute if score opcode cpu matches 1 run tellraw @p [{"text":"opcode "},{"score":{"name":"opcode","objective":"cpu"},"color":"red"},{"text":" not implemented!","color":"red"}]
...
execute if score opcode cpu matches 8 run tellraw @p [{"text":"addi "},{"score":{"name":"rt","objective":"cpu"}},{"text":", "},{"score":{"name":"rs","objective":"cpu"}},{"text":", "},{"score":{"name":"immediate","objective":"cpu"}}]
...
#
execute if score opcode cpu matches 16..31 run tellraw @p [{"text":"opcode "},{"score":{"name":"opcode","objective":"cpu"},"color":"red"},{"text":" not implemented!","color":"red"}]

#
execute if score opcode cpu matches 32..34 run tellraw @p [{"text":"opcode "},{"score":{"name":"opcode","objective":"cpu"},"color":"red"},{"text":" not implemented!","color":"red"}]
...
#
execute if score opcode cpu matches 36..42 run tellraw @p [{"text":"opcode "},{"score":{"name":"opcode","objective":"cpu"},"color":"red"},{"text":" not implemented!","color":"red"}]
...
#
execute if score opcode cpu matches 44..63 run tellraw @p [{"text":"opcode "},{"score":{"name":"opcode","objective":"cpu"},"color":"red"},{"text":" not implemented!","color":"red"}]
