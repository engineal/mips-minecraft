...
execute if score tmp_address mem matches 128.. run scoreboard players remove tmp_address mem 2
execute if score tmp_address mem matches 64.. at @e[name=mem_address] run teleport @e[name=mem_address] ~16 ~ ~
execute if score tmp_address mem matches 64.. run scoreboard players remove tmp_address mem 1
