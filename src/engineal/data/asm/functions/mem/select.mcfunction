...
execute if score tmp_address mem matches 32.. at @e[name=mem_address] run teleport @e[name=mem_address] ~32 ~ ~
execute if score tmp_address mem matches 32.. run scoreboard players remove tmp_address mem 32
execute if score tmp_address mem matches 16.. at @e[name=mem_address] run teleport @e[name=mem_address] ~16 ~ ~
execute if score tmp_address mem matches 16.. run scoreboard players remove tmp_address mem 16
execute if score tmp_address mem matches 8.. at @e[name=mem_address] run teleport @e[name=mem_address] ~8 ~ ~
execute if score tmp_address mem matches 8.. run scoreboard players remove tmp_address mem 8
execute if score tmp_address mem matches 4.. at @e[name=mem_address] run teleport @e[name=mem_address] ~4 ~ ~
execute if score tmp_address mem matches 4.. run scoreboard players remove tmp_address mem 4
execute if score tmp_address mem matches 2.. at @e[name=mem_address] run teleport @e[name=mem_address] ~2 ~ ~
execute if score tmp_address mem matches 2.. run scoreboard players remove tmp_address mem 2
execute if score tmp_address mem matches 1.. at @e[name=mem_address] run teleport @e[name=mem_address] ~1 ~ ~
