...
scoreboard players set value2 mips32r6_alu 9
function mips32r6:alu/sub
execute if score result mips32r6_alu matches 36 run scoreboard players add passed test 1
execute unless score result mips32r6_alu matches 36 run scoreboard players add failed test 1
execute unless score result mips32r6_alu matches 36 run tellraw @p [{"text":"Actual value: ","color":"red"},{"score":{"name":"result","objective":"mips32r6_alu"},"color":"red"},{"text":", Expected value: 36","color":"red"}]
