...
scoreboard players set physical_address mem 532676608
function rom:read
...
scoreboard players set physical_address mem 532676612
function rom:read
...
scoreboard players set physical_address mem 532677628
function rom:read
...
scoreboard players set physical_address mem 532677632
function rom:read
...
scoreboard players set physical_address mem 532677636
function rom:read
...
scoreboard players set physical_address mem 532678652
function rom:read
