...
execute if score opcode mips32r6_cpu matches 10 run tellraw @p [{"text":"slti not implemented!","color":"red"}]
execute if score opcode mips32r6_cpu matches 11 run tellraw @p [{"text":"sltiu not implemented!","color":"red"}]
