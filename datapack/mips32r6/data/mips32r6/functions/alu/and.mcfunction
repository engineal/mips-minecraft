...
function mips32r6:alu/and/loop

# bit 31
execute if score value1 mips32r6_alu matches ..-1 if score value2 mips32r6_alu matches ..-1 run scoreboard players operation result mips32r6_alu += shift mips32r6_alu
