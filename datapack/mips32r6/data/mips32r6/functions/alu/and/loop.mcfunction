...
execute if score tmp_value1 alu matches 1 if score tmp_value2 alu matches 1 run scoreboard players operation result alu += shift alu

scoreboard players operation shift alu += shift alu
execute if score shift alu matches 0.. run function mips32r6:alu/and/loop
