...
execute if score tmp_value1 mips32r6_alu matches 1 if score tmp_value2 mips32r6_alu matches 0 run scoreboard players operation result mips32r6_alu += tmp_shift mips32r6_alu
...
execute if score tmp_shift mips32r6_alu matches 0.. run function mips32r6:alu/xor/loop
