...
execute if score tmp_value1 mips32r6_alu matches 1 run scoreboard players operation result mips32r6_alu += shift mips32r6_alu
...
execute if score shift mips32r6_alu matches 0.. run function mips32r6:alu/or/loop
