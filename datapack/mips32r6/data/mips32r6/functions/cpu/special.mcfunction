...
execute if score funct mips32r6_cpu matches 9 run function mips32r6:cpu/special/jalr
...
execute if score funct mips32r6_cpu matches 34..38 run function mips32r6:cpu/special/alu_op
