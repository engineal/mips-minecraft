...
execute if score funct cpu matches 2 run function mips32r6:cpu/special/srl
...
execute if score funct cpu matches 12 run function mips32r6:cpu/special/syscall
...
execute if score funct cpu matches 32 run function mips32r6:cpu/special/alu_op
...
execute if score funct cpu matches 34 run function mips32r6:cpu/special/alu_op
...
execute if score funct cpu matches 36..38 run function mips32r6:cpu/special/alu_op
