...
# ALU operation
execute if score funct cpu matches 32 run function mips32r6:alu/add
execute if score funct cpu matches 34 run function mips32r6:alu/sub
execute if score funct cpu matches 36 run function mips32r6:alu/and
execute if score funct cpu matches 37 run function mips32r6:alu/or
execute if score funct cpu matches 38 run function mips32r6:alu/xor
