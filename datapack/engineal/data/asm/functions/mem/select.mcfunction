execute if score address mem matches 32768.. run tellraw @p [{"text":"address ","color":"red"},{"score":{"name":"address","objective":"mem"},"color":"red"},{"text":" out of range!","color":"red"}]
