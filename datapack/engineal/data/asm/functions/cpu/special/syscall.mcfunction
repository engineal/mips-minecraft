...
execute if score $v0 reg matches 1 run function asm:cpu/special/syscall/print_int
...
execute if score $v0 reg matches 4 run function asm:cpu/special/syscall/print_string
...
execute if score $v0 reg matches 10 run function asm:cpu/special/syscall/exit
