execute if score funct cpu matches 0 if score rs cpu matches 0 run function asm:cop0/mfc0
execute if score funct cpu matches 0 if score rs cpu matches 4 run function asm:cop0/mtc0
...
execute if score funct cpu matches 24 run function asm:cop0/eret
