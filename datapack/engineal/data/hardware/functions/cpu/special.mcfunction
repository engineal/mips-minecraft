...
execute if score funct cpu matches 2 run function hardware:cpu/special/srl
...
execute if score funct cpu matches 12 run function hardware:cpu/special/syscall
...
execute if score funct cpu matches 32 run function hardware:cpu/special/alu_op
...
execute if score funct cpu matches 34 run function hardware:cpu/special/alu_op
...
execute if score funct cpu matches 36..38 run function hardware:cpu/special/alu_op
