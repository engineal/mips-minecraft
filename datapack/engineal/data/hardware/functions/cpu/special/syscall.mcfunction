...
execute if score $v0 reg matches 1 run function hardware:cpu/special/syscall/print_int
...
execute if score $v0 reg matches 4 run function hardware:cpu/special/syscall/print_string
...
execute if score $v0 reg matches 10 run function hardware:cpu/special/syscall/exit
execute if score $v0 reg matches 11 run function hardware:cpu/special/syscall/print_char
