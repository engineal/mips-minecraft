...
# ALU operation
execute if score funct cpu matches 32 run function hardware:alu/add
execute if score funct cpu matches 34 run function hardware:alu/sub
execute if score funct cpu matches 36 run function hardware:alu/and
execute if score funct cpu matches 37 run function hardware:alu/or
execute if score funct cpu matches 38 run function hardware:alu/xor
