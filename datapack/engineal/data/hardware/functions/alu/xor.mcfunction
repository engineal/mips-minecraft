...
function hardware:alu/xor/loop

# bit 31
execute if score value1 alu matches ..-1 if score value2 alu matches 0.. run scoreboard players operation result alu += shift alu
