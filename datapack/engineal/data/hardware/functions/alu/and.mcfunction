...
function hardware:alu/and/loop

# bit 31
execute if score value1 alu matches ..-1 if score value2 alu matches ..-1 run scoreboard players operation result alu += shift alu
